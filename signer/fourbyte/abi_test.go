...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		{ // solidity.readthedocs.io/en/develop/abi-spec.html#use-of-dynamic-types
		...
		}, { // docs.soliditylang.org/en/develop/abi-spec.html#examples
...
[
	...
	for i, hexdata := range []string{
		...
		// From docs.soliditylang.org/en/develop/abi-spec.html
